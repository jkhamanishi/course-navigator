...
//window.onload = loadGrid(flexA);
$(document).ready(function(){loadGrid(flexA);});
//$(document).ready(loadGrid(flexA));
...
console.log(flexA); // var gridData from gridData.js
